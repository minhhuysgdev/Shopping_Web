            ...
            <div class="sidebar-item category">
                ...
                <div class="form">
                    <div class="text-field">
                        <span><img src="<?php echo URL_LAYOUT . 'img/product/women/icon.jpg' ?>" alt=""></span>
                        <a href="<?php echo URL . 'layout/women' ?>">Đồ Nữ</a>
                    </div>
                    <div class="text-field">
                        <span><img src="<?php echo URL_LAYOUT . 'img/product/men/icon.png' ?>" alt=""></span>
                        <a href="<?php echo URL . 'layout/men' ?>">Đồ Nam</a>
                    </div>
                    <div class="text-field">
...
<script>
    ...
    function filter_data(remin, remax) {
        ...
        $.ajax({
            url: "http://localhost/PHP/DOAN-CARONO/layout/productbags",
            method: "POST",
            data: {
                action: action,
                max_price: max_price,
